...
//            _fakeMapper.Setup(mapper => mapper.Map<List<Data.ViewModels.User>>(It.IsAny<IEnumerable<SignUp>>())).Returns(new List<Data.ViewModels.User>());
...
//            Assert.IsType<List<Data.ViewModels.User>>(result);
//        }
